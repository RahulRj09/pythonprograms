...
for i in range(len(questions)):
      ...
      if ans_key[i] == ans:
        ...
        print("\033[92m{}\033[00m".format("Congrats! Aapka answer sahi "+str(winer_price[i])+ " winer price aapko mila hai "+str(correct_answers)+ " answer sahi hey aapka"))
        sum = winer_price[i] 
        if i == 4:
           print("\033[93m{}\033[00m".format("Congrats! Aapka padaav pura ho gaya hai."))
        elif i == 9:
          print("\033[93m{}\033[00m".format("Congrats! Aapka doosra padaav pura ho gaya hai."))
        elif i == 14:
          print("\033[93m{}\033[00m".format("Congrats! Aap ek crore rupye jeet gaye hai." ))
      else:
